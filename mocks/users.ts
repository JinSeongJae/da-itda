...
export const JASMIN: User = {
  ...
  skillsOffered: [SKILLS.nativeEnglish, SKILLS.filipinoCooking, SKILLS.seAsianCulture],
...
export const LEE_JIEUN: User = {
  ...
  skillsWanted: [SKILLS.nativeEnglish, SKILLS.kidsEnglishExposure, SKILLS.filipinoCooking],
  availability: [
...
export const MINH: User = {
  ...
  skillsOffered: [SKILLS.seAsianCulture],
...
export const PARK_MINSU: User = {
  ...
  skillsOffered: [SKILLS.koreanLanguage, SKILLS.localInfoGyeongsan],
...
export const CHOI_SORA: User = {
  ...
  skillsOffered: [SKILLS.koreanHomeCooking, SKILLS.localInfoGyeongsan],
